...
#define __pyx_n_u_Enum __pyx_string_tab[3]
#define __pyx_n_u_RemoteConfigSourceName __pyx_string_tab[4]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[5]
#define __pyx_n_u_config __pyx_string_tab[6]
#define __pyx_n_u_database __pyx_string_tab[7]
#define __pyx_n_u_doc __pyx_string_tab[8]
#define __pyx_n_u_enum __pyx_string_tab[9]
#define __pyx_n_u_main __pyx_string_tab[10]
#define __pyx_n_u_metaclass __pyx_string_tab[11]
#define __pyx_n_u_module __pyx_string_tab[12]
#define __pyx_n_u_mro_entries __pyx_string_tab[13]
#define __pyx_n_u_name __pyx_string_tab[14]
#define __pyx_n_u_prepare __pyx_string_tab[15]
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_enum, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 8, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
 ...
 * 
 * 
 * class RemoteConfigSourceName(str, Enum):             # <<<<<<<<<<<<<<
 *     DB = "database"
 *     # NACOS = "nacos"
*/
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_Enum); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = PyTuple_Pack(2, ((PyObject *)(&PyUnicode_Type)), __pyx_t_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_6 = __Pyx_Py3MetaclassPrepare(__pyx_t_5, __pyx_t_2, __pyx_mstate_global->__pyx_n_u_RemoteConfigSourceName, __pyx_mstate_global->__pyx_n_u_RemoteConfigSourceName, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_config, (PyObject *) NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 *     # NACOS = "nacos"
*/
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_DB, __pyx_mstate_global->__pyx_n_u_database) < (0)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 *     # NACOS = "nacos"
*/
  __pyx_t_4 = __Pyx_Py3ClassCreate(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_RemoteConfigSourceName, __pyx_t_2, __pyx_t_6, NULL, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_4);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_RemoteConfigSourceName, __pyx_t_4) < (0)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{2},{4},{22},{18},{6},{8},{7},{4},{8},{13},{10},{15},{8},{11},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (157 bytes) */
const char* const cstring = "BZh91AY&SY\232SQK\000\000\003_\200@\000\000\001\000\000\236\001\030\000\277\257\376\000 \000\225\010\223\324\302mG\224\362A\223M\003AO\025\030\217\023D\323\324\336\244\314\211\036\214\351\306\320@\244\301s.fW\204w\301\251\224e<$v\302\362\363\217\333]\014]\236)\272\310[V*\013@R\344\022\301FhA\000\212\202\314\3149\311\342\347\241`f~A\302Te\321\351ju\351%\364\033S\337+\027\206\261\242\331TU\205\373\253\250o\342\356H\247\n\022\023Jj)`";
    PyObject *data = __Pyx_DecompressString(cstring, 157, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (123 bytes) */
const char* const cstring = "x\332%\214K\016\0021\014Co\304\025\220\370lY\300\001\"OjPE\333\014mz\177B\361\"v\222'\037\216\227\323\265\315zg5\347\331\3323\277\0366\273\362\206J-\271Qr\023\357Pn\320\267.\"\301\261aP$\231\2120\nD*\002\014U:\264`\214\265X\232\205+u\013\320{\346z\264\250\377\371\336\271\243\257\370\231(\377\363\240'>1\213\2138G\314/\303\363B\323";
    PyObject *data = __Pyx_DecompressString(cstring, 123, 1);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (168 bytes) */
const char* const bytes = ".?DBEnumRemoteConfigSourceNamecline_in_tracebackconfigdatabase__doc__enum__main____metaclass____module____mro_entries____name____prepare____qualname__setdefault__test__";
    PyObject *data = NULL;
