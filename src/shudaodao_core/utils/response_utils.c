...
static PyObject *__pyx_pf_14response_utils_12ResponseUtil_2error(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED PyObject *__pyx_v_cls, PyObject *__pyx_v_message, PyObject *__pyx_v_error, PyObject *__pyx_v_code); /* proto */
...
#define __pyx_kp_u_Optional_Any __pyx_string_tab[1]
...
#define __pyx_kp_u_config_app_config_2 __pyx_string_tab[7]
#define __pyx_kp_u_response_utils_py __pyx_string_tab[8]
#define __pyx_kp_u_schemas_response_2 __pyx_string_tab[9]
...
#define __pyx_n_u_ErrorResponse __pyx_string_tab[13]
#define __pyx_n_u_JSONResponse __pyx_string_tab[14]
#define __pyx_n_u_Optional __pyx_string_tab[15]
#define __pyx_n_u_Pyx_PyDict_NextRef __pyx_string_tab[16]
#define __pyx_n_u_Response __pyx_string_tab[17]
#define __pyx_n_u_ResponseUtil __pyx_string_tab[18]
#define __pyx_n_u_ResponseUtil_error __pyx_string_tab[19]
#define __pyx_n_u_ResponseUtil_success __pyx_string_tab[20]
#define __pyx_n_u_SuccessResponse __pyx_string_tab[21]
...
#define __pyx_n_u_fastapi_encoders __pyx_string_tab[33]
#define __pyx_n_u_fastapi_responses __pyx_string_tab[34]
...
#define __pyx_n_u_is_prod __pyx_string_tab[38]
...
#define __pyx_n_u_msg __pyx_string_tab[45]
...
#define __pyx_n_u_schemas_response __pyx_string_tab[53]
...
#define __pyx_kp_b_iso88591_A_3_a_t9F_9L_1_1H_4AQ __pyx_string_tab[61]
#define __pyx_kp_b_iso88591_A_6_d_5_1H_4AQ __pyx_string_tab[62]
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_cls,&__pyx_mstate_global->__pyx_n_u_message,&__pyx_mstate_global->__pyx_n_u_data,0};
...
*/
  ...
  __pyx_r = __pyx_pf_14response_utils_12ResponseUtil_success(__pyx_self, __pyx_v_cls, __pyx_v_message, __pyx_v_data);
...
static PyObject *__pyx_pf_14response_utils_12ResponseUtil_success(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED PyObject *__pyx_v_cls, PyObject *__pyx_v_message, PyObject *__pyx_v_data) {
...
*/
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_SuccessResponse); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 32, __pyx_L1_error)
...
*/
  ...
  __pyx_t_3 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_JSONResponse); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 35, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_6 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_7, __pyx_mstate_global->__pyx_n_u_jsonable_encoder); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 35, __pyx_L1_error)
  ...
  #endif
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_6, __pyx_v_response_model};
  ...
  #endif
  {
    ...
    __Pyx_GOTREF(__pyx_t_7);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_content, __pyx_t_2, __pyx_t_7, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 35, __pyx_L1_error)
 ...
 *     @classmethod             # <<<<<<<<<<<<<<
 *     def error(
 *             cls, *, message: str = '', error: Optional[Any], code: int = 500,
*/

/* Python wrapper */
static PyObject *__pyx_pw_14response_utils_12ResponseUtil_3error(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
...
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    PyObject ** const __pyx_pyargnames[] = {&__pyx_mstate_global->__pyx_n_u_cls,&__pyx_mstate_global->__pyx_n_u_error,&__pyx_mstate_global->__pyx_n_u_message,&__pyx_mstate_global->__pyx_n_u_code,0};
    const Py_ssize_t __pyx_kwds_len = (__pyx_kwds) ? __Pyx_NumKwargs_FASTCALL(__pyx_kwds) : 0;
    ...
    if (likely(__pyx_kwds_len > 0)) {
      ...
      const Py_ssize_t kwd_pos_args = __pyx_nargs;
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "error", 0) < (0)) __PYX_ERR(0, 37, __pyx_L3_error)
      if (!values[2]) values[2] = __Pyx_NewRef(((PyObject*)((PyObject*)__pyx_mstate_global->__pyx_n_u__2)));
      if (!values[3]) values[3] = __Pyx_NewRef(((PyObject*)((PyObject*)__pyx_mstate_global->__pyx_int_500)));
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("error", 1, 1, 1, i); __PYX_ERR(0, 37, __pyx_L3_error) }
      }
      for (Py_ssize_t i = 1; i < 2; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseKeywordRequired("error", *(__pyx_pyargnames[i - 0])); __PYX_ERR(0, 37, __pyx_L3_error) }
      }
    } else if (unlikely(__pyx_nargs != 1)) {
      goto __pyx_L5_argtuple_error;
    } else {
      __Pyx_RaiseKeywordRequired("error", __pyx_mstate_global->__pyx_n_u_error); __PYX_ERR(0, 37, __pyx_L3_error)
    }
    __pyx_v_cls = values[0];
    __pyx_v_error = values[1];
    __pyx_v_message = ((PyObject*)values[2]);
    if (__Pyx_PyInt_FromNumber(&values[3], "code", 0) < (0)) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_code = ((PyObject*)values[3]);
  }
  goto __pyx_L6_skip;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("error", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 37, __pyx_L3_error)
  __pyx_L6_skip:;
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L3_error:;
  for (Py_ssize_t __pyx_temp=0; __pyx_temp < (Py_ssize_t)(sizeof(values)/sizeof(values[0])); ++__pyx_temp) {
  ...
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_message), (&PyUnicode_Type), 0, "message", 2))) __PYX_ERR(0, 39, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_code), (&PyLong_Type), 0, "code", 2))) __PYX_ERR(0, 39, __pyx_L1_error)
  __pyx_r = __pyx_pf_14response_utils_12ResponseUtil_2error(__pyx_self, __pyx_v_cls, __pyx_v_message, __pyx_v_error, __pyx_v_code);
...
static PyObject *__pyx_pf_14response_utils_12ResponseUtil_2error(CYTHON_UNUSED PyObject *__pyx_self, CYTHON_UNUSED PyObject *__pyx_v_cls, PyObject *__pyx_v_message, PyObject *__pyx_v_error, PyObject *__pyx_v_code) {
  PyObject *__pyx_v_response_model = NULL;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
...
*/
  __pyx_t_2 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_ErrorResponse); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_mstate_global->__pyx_n_u_environment); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_is_prod); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 51, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
*/
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_JSONResponse); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 53, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_jsonable_encoder); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 53, __pyx_L1_error)
  ...
  #endif
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_7, __pyx_v_response_model};
  ...
  #endif
  {
    ...
    __Pyx_GOTREF(__pyx_t_8);
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_content, __pyx_t_2, __pyx_t_8, __pyx_callargs+1, 0) < (0)) __PYX_ERR(0, 53, __pyx_L1_error)
    __pyx_t_1 = __Pyx_Object_Vectorcall_CallFromBuilder((PyObject*)__pyx_t_5, __pyx_callargs+__pyx_t_4, (1-__pyx_t_4) | (__pyx_t_4*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET), __pyx_t_8);
    __Pyx_XDECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_jsonable_encoder};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_fastapi_encoders, __pyx_imported_names, 1, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_JSONResponse,__pyx_mstate_global->__pyx_n_u_Response};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_fastapi_responses, __pyx_imported_names, 2, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_SuccessResponse,__pyx_mstate_global->__pyx_n_u_ErrorResponse};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_schemas_response, __pyx_imported_names, 2, __pyx_mstate_global->__pyx_kp_u_schemas_response_2, 2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_message, ((PyObject*)__pyx_mstate_global->__pyx_n_u_)) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
 ...
 *         """
*/
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_data, Py_None) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_message, __pyx_mstate_global->__pyx_n_u_str) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_data, __pyx_mstate_global->__pyx_kp_u_Optional_Any) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_n_u_Response) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_6 = __Pyx_CyFunction_New(&__pyx_mdef_14response_utils_12ResponseUtil_1success, __Pyx_CYFUNCTION_CLASSMETHOD, __pyx_mstate_global->__pyx_n_u_ResponseUtil_success, NULL, __pyx_mstate_global->__pyx_n_u_response_utils, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 22, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_Method_ClassMethod(__pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_success, __pyx_t_5) < (0)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_message, ((PyObject*)__pyx_mstate_global->__pyx_n_u__2)) < (0)) __PYX_ERR(0, 37, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_code, ((PyObject*)__pyx_mstate_global->__pyx_int_500)) < (0)) __PYX_ERR(0, 37, __pyx_L1_error)
  __pyx_t_6 = __Pyx_PyDict_NewPresized(4); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  if (PyDict_SetItem(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_message, __pyx_mstate_global->__pyx_n_u_str) < (0)) __PYX_ERR(0, 37, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_error, __pyx_mstate_global->__pyx_kp_u_Optional_Any) < (0)) __PYX_ERR(0, 37, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_code, __pyx_mstate_global->__pyx_n_u_int) < (0)) __PYX_ERR(0, 37, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_return, __pyx_mstate_global->__pyx_n_u_Response) < (0)) __PYX_ERR(0, 37, __pyx_L1_error)
  __pyx_t_4 = __Pyx_CyFunction_New(&__pyx_mdef_14response_utils_12ResponseUtil_3error, __Pyx_CYFUNCTION_CLASSMETHOD, __pyx_mstate_global->__pyx_n_u_ResponseUtil_error, NULL, __pyx_mstate_global->__pyx_n_u_response_utils, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[1])); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_Method_ClassMethod(__pyx_t_4); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (__Pyx_SetNameInClass(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_error, __pyx_t_6) < (0)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 * 
*/
  __pyx_t_6 = __Pyx_Py3ClassCreate(((PyObject*)&PyType_Type), __pyx_mstate_global->__pyx_n_u_ResponseUtil, __pyx_mstate_global->__pyx_empty_tuple, __pyx_t_2, NULL, 0, 0); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_6);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_ResponseUtil, __pyx_t_6) < (0)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{179},{13},{75},{1},{25},{1},{8},{18},{17},{17},{12},{3},{9},{13},{12},{8},{20},{8},{12},{18},{20},{15},{15},{18},{18},{3},{4},{17},{7},{4},{7},{11},{5},{16},{17},{8},{3},{13},{7},{5},{16},{8},{7},{13},{10},{3},{8},{3},{11},{12},{14},{14},{6},{16},{12},{10},{3},{7},{8},{6},{6},{71},{52}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (800 bytes) */
const char* const cstring = "BZh91AY&SY=\276\002\324\000\000E\177\377\340}\347\022\345\243/`\257u\372\013\277\377\377d\177\327\354\374\373\301\350\337@@@@G\340\300\000@\002|\240\002\002(\231\244\311\220\232f\247\251\246\206F\t\240\323&\200\032\000\006!\220\003CF\200h\030\020\332\217Q\247\251\355(\203&\000L\000\004\300\021\246\021\200\000\000\002d\323\023A\200\021\200\000\000\000A\223\000&\000\002`\010\323\010\300\000\000\0012i\211\240\300\010\300\000\000\000\r4D\310\3220\204\332$\321\250\364\000L\230\023\020\320i\20044\3204A\2022\030\214\023L\004\r'\215\233\260}>\016\351\366\017bN?\235e\361}\351\357Pm\036Y\307h@;\333wx\233\002f\016\036\226\215z;N6\226\311\335\006\207!\335'\r:ie\232j5V\217o2\334\003\206e'\203W7I\341M\215\001\360\303\310\304\214\005\266s\322l\027\276\262\232\024\023C\205\"\322H\246\207\203\004\240H\207'f\001\232\246\230\026@\371\374\247\316\312;?\224U\035\212\331\n5\025\036D!\245\246\306['\213\216R\223I\202\316\342\tqE!vj\034@\200/\017h\351\267\"\035I\207\305\243\250\311\323\313\271\240g\013(\007\022e\036\231\360\333;\3640\3307\031+\370\355z;*f\0070\2706\241p\243\026Q\232V\360py\266\311_Z\225\t\234\353\360\277-\365!1U\217 qZ\2310\325\rK&\351\275^\242W\2015\341k\3153M\23135\341\232h\220H\2047\322Q\272\001\214\332\n1t\254{\226H+9\021\307!jR\360\"\241\213\243,\344\017Aa\242\2300\210i\3310d\315}nz\327\n\322AR\234s3\225\354\312\036\256\234\205K\0316\345\316\302\260E\001\325\230\353\246\020\205DE\001\005\250\216\007 G\301H\323\025\207YU\304Ei\315\233\001\023\016\211\020\314@\212U\024U\224\332\340\372\310\256\227\332\010\245\002[k\202\215\260\316\307<\201\304am7\243F\262\346\027\345+\243E\210\361\264\276\220z\254TQ|21x8)t\301\202\007\003UAE7\014\370\240H\311A \202Di\"Qs\311\330\335z\227<\260\255\314\241\325:cT\200\307\324L\"\262'\302'\200\215\340\314Y\210@\365\244\323B\031 k\307\214\356\322<\031\003\244QE\262\r\313\210KV\350\021t,0\212`\307\371Z\237\360[\310\352\2270\0260\203\251{\023\21638\002\177\027\030\251\244\201\244\242%[\025\312D$\274\002\346xK\252\205fk5Z\250\274\273\302\324""\361X=\275\205\225\202\346\207\244\312jZ(i\n2\251Rpm\203\363\2017\t\235~2\300\225\230\214\265\304\023\253\273L!F\256\022IL\227\000\245\017\334\341\215R\213\266\2347XJ\231KE\204\260\210j\264v#\036\273\n+\305^\013\205\362Q\372\017\361w$S\205\t\003\333\340-@";
    PyObject *data = __Pyx_DecompressString(cstring, 800, 2);
...
const char* const cstring = "x\332eSMO\023A\030\2667A\242\222\250\007\022\342\230\030\211\0077!\242\221\023i\020\242\306\000B<\031\235Lw\337\266\203\333\231uf\226\320\304\203\370\201\r\261ZC\023\213\222P0JO\264\206\003\004\320x\364\310\261G\016\335~\234\364'8[\272\004q\222\235y\366\235\367y\346\375\230\031\341\n\220\212\023\205\006\223*\316\031\242\022Y`\323\010\010\242\300N\"\251\0045\025\010\337\211\241\261\241\261+}7\372\020a\026\0220\t\246\222H\272\021\323&R\202D<\212\".\265\025eH%\035\220\006\272\035EI\356\"\006`!\305\221\243\375\016\023T\034\030\222\240|\200z\010c\\\021E9\303\232NY\254\007YT\350C\350\024\370\354abK0F\035\337\203\330\017\302,\371\260\226]\252l\255\326\336\026\275\225\027\225\315t\365]\246\362\343S\275\370\265\266=\333\310.\324\213\305\337;o\352\305\215\372L\266\266\276][[\256ef\275\367\271\372\352gov\2751\363\332K\225j\037_6>\2545VrF;\322\303\233O{[Yo\343\213\367j\243\366m\273i\033 \226\205uh`\230\234Ei\314 \216\203\367\241\000\351p&\001\273\212\332\322p\222\2064\343\220 \322\010v\252\363\351\312\367\305j*\343\315-\351\210\303\2163\330d\016\t\301\305x\313\351\316\304\350H\200\203\3740\036KN\353\357\246\256?\036\201i5\016\321\300'X\357\353S\017c\003\016\2536-\3225M\220rb\177\t\266\252\213ion\331[(x;\317\275\315M\"\223\314\244\\\347'\270\316\204\2014m=c\252;!\210\t\021b>6mir\013\376+\201\236\0250e\021E0\266\270\2111\260)*8Khk3\236(\221\2128\324\000\346\013\010\031\374\007%\222\030G]\246\211\224)L%>\210BcGp\213*H\310I\251\213\022\261\001\267T0N\020\035\036N\350\254H\014|\240H\363^a=\022\334rm\337(c\0303\222\320\320\341\216\236\0048D\200\357\362\304%\366\376\316A\0235\013\354\177[*@\271\202\035m*\306\372\322\266t5\262 J\\[\351\267\322\2526\306\n\244\302\255k<El\027\344\263\360\336\231\356\335\356\253\245\201\237\227~\205\312m\355\177N\037k\353\312u\347I\271\2433s.\243r\375\371\341\302\205\275\343'R\375\231\273\371P\271\243+w9\337[>~*\3654\327\233\273\265{\261\257\024.\335k\312\344\036\025\256\227:}\215\223\276\306\371B\310\3278\233\2614\343Z!\264w\204\363\027\335D\252\374";
...
const char* const bytes = "Note that Cython is deliberately stricter than PEP-484 and rejects subclasses of builtin types. If you need to pass subclasses then set the 'annotation_typing' directive to False.Optional[Any]\347\224\237\344\272\247\347\216\257\345\242\203\344\270\215\346\217\220\344\276\233\350\257\246\347\273\206\351\224\231\350\257\257\357\274\214\350\257\267\350\201\224\347\263\273\347\256\241\347\220\206\345\221\230\350\247\243\345\206\263\351\201\207\345\210\260\347\232\204\351\227\256\351\242\230.\n    \345\223\215\345\272\224\345\267\245\345\205\267\347\261\273\n    ?add_note.config.app_configresponse_utils.py.schemas.response\346\223\215\344\275\234\346\210\220\345\212\237AnyAppConfigErrorResponseJSONResponseOptional__Pyx_PyDict_NextRefResponseResponseUtilResponseUtil.errorResponseUtil.successSuccessResponse\346\234\215\345\212\241\345\231\250\345\274\202\345\270\270asyncio.coroutinescline_in_tracebackclscodeconfig.app_configcontentdata__doc__environmenterrorfastapi.encodersfastapi.responses__func__int_is_coroutineis_proditemsjsonable_encoder__main__message__metaclass____module__msg__name__pop__prepare____qualname__response_modelresponse_utilsreturnschemas.response__set_name__setdefaultstrsuccess__test__typingvalues\200A\340\024\035\320\0353\260?\300&\310\001\330\t\n\360\020\000\t\032\230\035\240a\330\014\021\220\026\220t\2309\240F\250!\340\010\013\2109\220L\240\001\330\014\032\230)\2401\330\010\017\210|\2301\230H\320$4\260A\260Q\200A\340\024\035\230^\2506\260\021\330\t\n\360\016\000\t\032\230\037\250\001\330\014\021\220\025\220d\230)\2405\250\001\340\010\017\210|\2301\230H\320$4\260A\260Q";
    PyObject *data = NULL;
  ...
  }
  {
    ...
    int16_t const cint_constants_2[] = {200,500};
    for (int i = 0; i < 2; i++) {
...
static int __Pyx_CreateCodeObjects(__pyx_mstatetype *__pyx_mstate) {
  ...
  {
    const __Pyx_PyCode_New_function_description descr = {1, 0, 2, 4, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 22};
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[0] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_response_utils_py, __pyx_mstate->__pyx_n_u_success, __pyx_mstate->__pyx_kp_b_iso88591_A_6_d_5_1H_4AQ, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[0])) goto bad;
  }
  {
    const __Pyx_PyCode_New_function_description descr = {1, 0, 3, 5, (unsigned int)(CO_OPTIMIZED|CO_NEWLOCALS), 37};
    ...
    __pyx_mstate_global->__pyx_codeobj_tab[1] = __Pyx_PyCode_New(descr, varnames, __pyx_mstate->__pyx_kp_u_response_utils_py, __pyx_mstate->__pyx_n_u_error, __pyx_mstate->__pyx_kp_b_iso88591_A_3_a_t9F_9L_1_1H_4AQ, tuple_dedup_map); if (unlikely(!__pyx_mstate_global->__pyx_codeobj_tab[1])) goto bad;
  }
