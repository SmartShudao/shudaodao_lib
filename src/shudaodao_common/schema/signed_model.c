...
#define __PYX_HAVE__signed_model
#define __PYX_HAVE_API__signed_model
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "signed_model" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "signed_model"
extern int __pyx_module_is_main_signed_model;
int __pyx_module_is_main_signed_model = 0;

/* Implementation of "signed_model" */
...
#define __pyx_n_u_ResponseSignedModel __pyx_string_tab[4]
#define __pyx_n_u_Url __pyx_string_tab[5]
...
static int __pyx_pymod_exec_signed_model(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_signed_model},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_signed_model(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_signed_model(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_signed_model(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'signed_model' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "signed_model" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_signed_model", 0);
  ...
  if (__pyx_module_is_main_signed_model) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "signed_model")) {
      if (unlikely((PyDict_SetItemString(modules, "signed_model", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  {
    ...
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_pydantic, __pyx_imported_names, 2, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
...
*/
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_BaseModel); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_6 = __Pyx_Py3MetaclassPrepare(__pyx_t_5, __pyx_t_2, __pyx_mstate_global->__pyx_n_u_ResponseSignedModel, __pyx_mstate_global->__pyx_n_u_ResponseSignedModel, (PyObject *) NULL, __pyx_mstate_global->__pyx_n_u_signed_model, (PyObject *) NULL); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 12, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_4);
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_key, __pyx_mstate_global->__pyx_n_u_int) < (0)) __PYX_ERR(0, 12, __pyx_L1_error)
  if (PyDict_SetItem(__pyx_t_4, __pyx_mstate_global->__pyx_n_u_url, __pyx_mstate_global->__pyx_n_u_str) < (0)) __PYX_ERR(0, 12, __pyx_L1_error)
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_annotations, __pyx_t_4) < (0)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  __pyx_t_7 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_8, __pyx_mstate_global->__pyx_n_u_Field); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  __pyx_t_9 = 1;
  {
    ...
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_description, __pyx_mstate_global->__pyx_n_u__2, __pyx_t_10, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_key, __pyx_t_4) < (0)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  __pyx_t_8 = NULL;
  __Pyx_GetModuleGlobalName(__pyx_t_10, __pyx_mstate_global->__pyx_n_u_Field); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_9 = 1;
  {
    ...
    if (__Pyx_VectorcallBuilder_AddArg(__pyx_mstate_global->__pyx_n_u_description, __pyx_mstate_global->__pyx_n_u_Url, __pyx_t_7, __pyx_callargs+2, 0) < (0)) __PYX_ERR(0, 14, __pyx_L1_error)
  ...
  if (__Pyx_SetNameInClass(__pyx_t_6, __pyx_mstate_global->__pyx_n_u_url, __pyx_t_4) < (0)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 *     url: str = Field(..., description="Url")
*/
  __pyx_t_4 = __Pyx_Py3ClassCreate(__pyx_t_5, __pyx_mstate_global->__pyx_n_u_ResponseSignedModel, __pyx_t_2, __pyx_t_6, NULL, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_4);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_ResponseSignedModel, __pyx_t_4) < (0)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init signed_model", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init signed_model");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{9},{5},{19},{15},{18},{15},{18},{11},{7},{3},{3},{8},{13},{10},{15},{8},{11},{8},{12},{10},{12},{3},{8},{3}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (200 bytes) */
const char* const cstring = "x\332%\2171NCA\014Do\304\025\220(\350h@\324\226\331\035\320*\376\336e\355_\244\004%PEJ\205\020\025\242\242IK\023)\247\341\363\305-\330,\256\306\363\354\221\346\344\364\214\r\0279B\316\023$^\302JV\303U\272S\304\356\377~\254\346\335a\332n\346\267\325u\225i\367:=~\376\274<\177\357\277\246\247\365\374\376@\304\252\331\331S\373$\n\222\024\224\224\274r\300\r\207E\204\205\232\312\221\023\305\034\250Q_`I4p\273k3\3009\010\233\365%\307Q\320U\315\004\365\232\320\201\362\320\355RQ\2706Y\226\221\325S\013\274\037Y\376\261\301#ny\024\267\336\341\030\0071\257D\016s\242\261\312\037\0212l\006";
    ...
    #endif
    #else /* compression: none (246 bytes) */
const char* const bytes = ".?BaseModelFieldResponseSignedModel\351\242\204\347\255\276\345\220\215\347\232\204Url\345\255\230\345\202\250\346\226\207\344\273\266\345\206\205\347\240\201__annotations__cline_in_tracebackdescription__doc__intkey__main____metaclass____module____mro_entries____name____prepare__pydantic__qualname__setdefaultsigned_modelstr__test__url";
    PyObject *data = NULL;
